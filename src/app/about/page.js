  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="container mx-auto px-4 py-16">
        <button
          onClick={() => router.back()}
          className="mb-8 px-6 py-3 bg-gray-800/40 backdrop-blur-sm hover:bg-gray-700/60 text-white rounded-xl transition-all duration-300 flex items-center space-x-2 border border-gray-600/30 shadow-lg hover:shadow-blue-500/20 group"
        >
